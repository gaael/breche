...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference("Day.count") do
      post days_url, params: { day: { description: @day.description, number: @day.number, session_id: @day.session_id, theme: @day.theme } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { description: @day.description, number: @day.number, session_id: @day.session_id, theme: @day.theme } }
